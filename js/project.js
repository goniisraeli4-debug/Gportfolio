  ...
  function openHtml() {
    ...
    return `
      <header class="slide slide--open">
        <p class="open__eyebrow reveal reveal--text"><img class="open__icon" src="assets/open-icon.png?v=logo-5" alt="" width="14" height="14" decoding="async" /><span aria-hidden="true">—</span> ${esc(project.discipline)}</p>
